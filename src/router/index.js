...
import InOutstock from '@/view/warehouse/inOutstock'
      ...
      children: [
        ...
        { 
          ...
          children: [
            ...
            { path: 'userEdit', component: UserEdit, name: '员工信息更新'  },
        ...
        { 
          ...
          children: [
            ...
            { path: 'inOutstock', component: InOutstock, name: '出入库单'  },
        ...
        { 
          ...
          component: Product,
          children: [
            { path: 'chengben', component: Chengben, name: '商品成本'  },
            { path: 'kucun', component: Kucun, name: '商品库存'  },
            { path: 'shuxing', component: Shuxing, name: '商品属性管理'  },
        ...
        { 
          ...
          children: [
            ...
            { path: 'orderColleague', component: OrderColleague, name: '所属员工业绩' },
