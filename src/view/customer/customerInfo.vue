...
<div class="cum_search">
  ...
  <div class="ads">
  <el-input v-model="input" placeholder="请输入客户编号名称" ></el-input>
  ...
  <div class="add_btn">
       <el-button type="primary" @click="handleCreate">新增</el-button>
         <el-dialog title="客户信息" :visible.sync="dialogFormVisible">             
              <el-form :model="form">
                <el-form-item label="客户类型" width="formLabelWidth">
       ...
       <el-button disabled="disabled">启用</el-button>
       <el-button @click="handleDelete" disabled="disabled">删除</el-button>    
  </div>
<!-- 客户信息表格 -->
 <div class="cum_table">
    <el-table
