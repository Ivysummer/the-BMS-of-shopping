      ...
      <el-tabs type="border-card">
        <el-tab-pane>
          <span slot="label"><i class="el-icon-plus">&nbsp;&nbsp;</i>入款单</span>
            ...
            <el-table class="table" :data="tableData" border style="width: 100%">
              <el-table-column prop="jilu_date" label="录入时间" sortable width="200" align="center">
              </el-table-column>
              <el-table-column prop="jilu_input" label="单据编号" sortable width="200" align="center">
              </el-table-column>
              <el-table-column prop="pay_name" label="付款方" width="200" align="center">
              </el-table-column>
              <el-table-column prop="do_name" label="经手人" width="200" align="center">
              </el-table-column>
              <el-table-column prop="region" label="部门" width="200" align="center">
              </el-table-column>
              <el-table-column prop="jilu_get" label="利润收益（¥）" width="200" align="center">
              </el-table-column>
            </el-table>
        </el-tab-pane>
        ...
        <el-tab-pane>
          <span slot="label"><i class="el-icon-minus">&nbsp;&nbsp;</i>出款单</span>
            <!-- 出款单表格数据显示 -->
            <el-table class="table" :data="tableData2" border style="width: 100%">
              <el-table-column prop="jilu_date" label="录入时间" sortable width="200" align="center">
              </el-table-column>
              <el-table-column prop="jilu_input" label="单据编号" sortable width="200" align="center">
              </el-table-column>
              ...
              <el-table-column prop="jilu_charge" label="收取金额（¥）" width="200" align="center">
              </el-table-column>
            </el-table>
        </el-tab-pane>
      </el-tabs>
