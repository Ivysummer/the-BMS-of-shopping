 ...
 <div class="createPost-container" v-cloak>
    <div class="createPost-main-container" v-loading="infoLoading">
      ...
      <div class="table-container">
        <el-table ref="goodTable" :data="goodList" element-loading-text="拼命加载中" fit highlight-current-row style="width: 98%;" show-summary :summary-method="getSummaries">
          <el-table-column align="center" width="100px" label="商品主图">
            <template scope="scope">
              {{scope.row.url}}
              <!-- <div v-for="item in imgUrl" :key="item" style="width: 60px;height: 60px;padding-top: 5px;">
                <img :src="item" />
              </div> -->
            </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        goodList:[],
        imgUrl:[require("./../../assets/good1.jpg"),require("./../../assets/good2.jpg")]
      };
    },
    props: {
      orderId: {
