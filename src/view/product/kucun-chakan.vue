<template>
  <div class="post1">
    ...
    <div class="one">
      ...
      <el-button  type="info"><i class="fa fa-search" @click="handleSearch" aria-hidden="true"></i>  搜索</el-button>
    ...
    <el-table ref="multipleTable" :data="tableData3" border tooltip-effect="dark" style="width: 100%" @selection-change="" height="500" show-summary>
        ...
        <el-table-column prop="address" label="仓库位置" show-overflow-tooltip width="250" align="center">
        </el-table-column>

        <el-table-column prop="detail" label="详细信息" show-overflow-tooltip width="100" align="center">
        </el-table-column>

        <el-table-column prop="manager" label="负责人" show-overflow-tooltip align="center">
        </el-table-column>

        <el-table-column prop="start" label="入仓时间" show-overflow-tooltip width="100" align="center">
        </el-table-column>
        
        <el-table-column prop="price" label="单价" sortable show-overflow-tooltip width="100" align="center">
        </el-table-column>

        <el-table-column prop="amount" label="数量" sortable show-overflow-tooltip width="100" align="center">
        </el-table-column>
  ...
  export default {
      ...
      methods: {
            ...
            handleSearch() {
              ...
              var vm = this;
              // 假查询
              this.$http.get(api.chakan,{params:vm.name}).then(function(response){
                  // alert(1);
