  ...
  <div class="post">
    ...
    <div class="one">
      <el-tabs type="border-card">
        ...
        <el-tab-pane label="商品属性管理">
          <el-row :gutter="20">
            <el-col :span="8">                
                <div class="user_img" >
                    <!-- <img :src="ImgUrl" alt="商品样式" > -->
            ...
            <el-col :span="16">
                <div class="user_info">
                    <h2>商品信息 <el-button size="small" v-if="!editable" @click="editable = true" style="float:right;" icon="edit">编辑</el-button> </h2>
  ...
  export default {
      data () {
          return {
             ...
             options2: [
               {key:"01", value:"江苏"},{key:"02", value:"浙江"}
               ],
             props: {
               value: 'label',
               children: 'cities'
             },
             regoin: [{key:"01", value:"区域一"},{key:"02", value:"区域二"}],
          };
      },
      computed: {
            ...mapGetters({
