    ...
    <div id="table_box">
        ...
        <div class="show_message_box">
             <div class="show_message">
                ...
                <el-table-column prop="id" label="序号" width="95" align="center" sortable></el-table-column>

                <el-table-column label="商品信息" style="text-align:center;color:red;">
                  <el-table-column  prop="No" label="产品编号"  width="110" align="center" show-overflow-tooltip></el-table-column>
                  <el-table-column prop="name"label="商品名称" width="150" align="center"></el-table-column show-overflow-tooltip>
                  <el-table-columnprop="size" label="规格" width="95" align="center"></el-table-column>
                  <el-table-column prop="version" label="型号" width="95" align="center" show-overflow-tooltip></el-table-column>
                  <el-table-column prop="manu" label="产地" width="95" align="center"></el-table-column>
                 <!--  <el-table-column prop="danwei" label="单位" width="95" align="center"></el-table-column> -->
                </el-table-column>

                <el-table-column label="总仓库">
                  <el-table-column prop="quantity" label="数量" width="95" align="center"></el-table-column>
                  <el-table-column prop="money" label="金额(万元)"  width="110" align="center"></el-table-column>
                </el-table-column>

                <el-table-column label="库房-北京站">
                  <el-table-column prop="quantity2" label="数量" width="95" align="center"></el-table-column>
                  <el-table-column prop="money2" label="金额(万元)" width="110" align="center"></el-table-column>
                </el-table-column>

                <el-table-column label="库房-广州站">
                  <el-table-column prop="quantity3" label="数量" width="95" align="center"></el-table-column>
                  <el-table-column prop="money3" label="金额(万元)" width="110" align="center"></el-table-column>
                </el-table-column>
      ...
      <div class="tab-btn">
            <div class="bt-f">
              <ul><li><button class="button-li" disabled="disabled">查询条件</button></li>
                <li><button class="button-li" disabled="disabled">明细账本</button></li>
                <li><button class="button-li" disabled="disabled">价格方式</button></li>
              </ul>
            </div>
            <div class="bt-rg">
               <ul>
                <li><button disabled="disabled">打印</button></li>
                <li><button disabled="disabled">退出</button></li>
               </ul>
            </div>
      </div>
